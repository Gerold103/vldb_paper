...
After the deferred update is implemented all hidden reads disappears.
...
least twice faster than classical according to the calculations below:
\begin{gather*}
...
than access to memory even for SSD. And exectly on disk speed depends the
...
O(log_bm)
\end{displaymath}
Insert DELETE into primary indexe's memory level only.
