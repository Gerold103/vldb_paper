...
Such tuples, visible in a secondary index and is not visible in a primary one
are called \textbf{dirty}.
...
newer versions among compacting sublevels. That is if a tuple has newer version
